...
export function SiteMap() {
  ...
  useEffect(() => {
    ...
    ctx.restore();
  }, [showHeatMap, showMachines, showWorkers, showZones, machines, workerPositions, heatZones, zones, zoomLevel, panOffset]);
  ...
  const resetView = () => {
    ...
    toast.info('View Reset', { description: 'Map view has been reset to default' });
  };
          ...
          <Card className="border-gray-800 bg-gray-900 lg:col-span-1">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3 border-t border-gray-800 pt-5">
                <h3 className="text-white font-semibold">Zoom Controls</h3>
