          ...
          <div className="space-y-6">
            <Card className="bg-gray-900 border-gray-800">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="site-location" className="text-gray-300">
                    Location
                  </Label>
                  <Input
                    id="site-location"
            ...
            <Card className="bg-gray-900 border-gray-800">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="video-retention" className="text-gray-300">
                ...
                <div className="space-y-2">
                  <Label htmlFor="alert-retention" className="text-gray-300">
          ...
          <div className="space-y-6">
            <Card className="bg-blue-950/30 border-blue-800">
              ...
              <CardContent className="text-sm text-blue-200 space-y-2">
                <p>
                  For live webcam detection to work, you need to allow camera
                ...
                <ul className="text-xs text-blue-200 space-y-1 list-disc list-inside ml-2">
                  <li>
                    Click the camera icon (🎥) or lock icon (🔒) in your
                ...
                <p className="text-xs text-blue-300 mt-3">
                  <strong>Note:</strong> Camera access is only used for
                  real-time safety monitoring and is never recorded without your
                  consent.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">
                  Configure PPE detection parameters
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-400">
                      Enable helmet/hard hat detection
                    </div>
                  </div>
                  <Switch defaultChecked />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-400">
                      Enable high-visibility vest detection
                    </div>
                  </div>
                  <Switch defaultChecked />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-400">
                      Enable fall protection harness detection
                    </div>
                  </div>
                  <Switch defaultChecked />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="scan-interval" className="text-gray-300">
                  ...
                  />
                  <p className="text-xs text-gray-400">
                    How often to run detection on camera feeds
                  </p>
                </div>
        ...
        <TabsContent value="users">
          <Card className="bg-gray-900 border-gray-800">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-400">
                      lars@example.com • Safety Officer
                    </div>
                  </div>
                  <Button
                    variant="outline"
              ...
              <Button className="mt-4 bg-[#FF7A00] text-white hover:bg-[#FF7A00]/90">
                Add New User
              </Button>
            </CardContent>
          </Card>
